                    ...
                    <div class="row">
                        ...
                        if (count($content) > 0) {
                            ...
                            <div class='table-responsive table-sales'>
                                ...
                                <div class='col-md-1'>
                                    <a href='". esc_url(add_query_arg( 'c', $row->slug, site_url( '/product-edit/' ) ) )."' class='btn-simple btn-default btn-edit-product' style='background: none'><i class='material-icons'>edit</i></a>
