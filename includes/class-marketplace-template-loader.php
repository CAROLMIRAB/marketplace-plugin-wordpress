...
if (!class_exists('MarketPlace_Template_Loader')) {
    class MarketPlace_Template_Loader
    {
        protected $filter_prefix = 'marketplace';
        protected $theme_template_directory = 'marketplace';
        protected $plugin_directory = MARKETPLACE_PLUGIN_DIR;
